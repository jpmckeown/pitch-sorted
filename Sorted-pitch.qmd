...
::: {.notes}
This pitch originated from an earlier game idea called Pigeonwhole which featured billiard balls and table pockets, and its theme was the pigeonholing of people. I hope a game can be fun and also a nonverbal allegory. An inspiration for that is the recent Animal Farm game based on George Orwell's book.
:::
...
Perspective: 2D, not strictly overhead
...
::: {.notes}
If you have any query feel free to message me @Patrick
...
Art: terrain tiles, sheep, rogue dog
...
::: {.notes}
What kind of roles? Above all I need music, ideally two pieces of music one playing over menu and in-game before sorting starts, and the other after sorting. The first like JS Bach "Sheep May Safely Graze", the second with edginess but still gentle. Also I am especially looking for help with art and playtesting. It would be good to have small particle effects for significant moments such as when 
:::
...
::: {.notes}
The code is based on the Classic Games Course following that style which will be familiar. Level design and is through a number grid as in the Classic games. SoundFX for UI events can be various boops randomized from a synthesizer. Other soundFX should be designed or recorded and filtered. Trello cards give advice or please ask me.
:::
