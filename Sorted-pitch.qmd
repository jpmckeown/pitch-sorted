...
::: {.notes}
During assessment sheep are kept steady by going in a clamp, one at a time. High-end clamps are elevated and this inspired a game feature.
:::

## Inspiration {background-image="img/elevated-clamp.jpg"}

![](img/sortingHat.jpg){.absolute left=900 top=480 width="225" height="225"}

::: {.notes}
The player's icon symbolically represents the clamp and shepherd combined. Placeholder art is a Sorting Hat because it reminds me of sorting a Hogwarts pupil into one of the team houses.
:::
...
"Sorted" is a comedy puzzle game. The player, a shepherd, wants the sheep to reach the correct pen - like in the BBC TV program "One Man and His Dog". Each level will have a tiled map design choosing from a dozen terrain types which affect sheep movement. The game is relaxed.
