...
Contributed to 12 HomeTeam games: mostly sounds (synth & real), sprites, writing, and shapes.
:::
...
![](img/fairy_on_grass.png){.absolute top=0 left="50%" width="668" height="467"}
![](img/flowerpot1.png){.absolute top="48%" left="50%" width="384" height="192"}
![](GIF/flowerpot_transparent.GIF){.absolute top="55%" left="50%" width="64" height="64"}
![](img/hovertactics.png){.absolute top="55%" left=0 width="408" height="302"}

::: {.notes}
Glitch GIFs; IAT logo; tree? Pit-rifle?
:::
