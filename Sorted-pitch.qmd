...
::: {.notes}
Making space for UI in bottom row, there's only one of each goal tile, and it leads to ramp of a waiting lorry.
:::
...
::: {.notes}
A level ends when all sheep have reached bottom of screen, in goal tile or at road fence. Points awarded for each sheep, highest score if on correct goal, otherwise depends on how far from centre of screen. Then a piper appears at centre and hearing piper's tune sheep at the fence move to gap and into lorry. Once full the lorry drives off.
:::
