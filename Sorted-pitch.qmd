...
![](img/fairy_on_grass.png){.absolute top=0 left="50%" width="366" height="182"}
![](img/flowerpot1.png){.absolute top="48%" left="50%" width="384" height="192"}

![](GIF/flowerpot_transparent.gif){.absolute top="15%" left="50%" width="64" height="64"}
![](GIF/flowerpot_blue.gif){.absolute top="15%" left="30%" width="64" height="64"}

![](img/hovertactics.png){.absolute top="55%" left=0 width="408" height="302"}

![](GIF/item_shift.gif){.absolute top="75%" left="50%" width="64" height="64"}
![](GIF/item_threadpool.GIF){.absolute top="75%" left="65%" width="64" height="64"}
![](GIF/item_computercluster.GIF){.absolute top="75%" left="80%" width="64" height="64"}

![](img/IAT_logo_Aurora_320.png){.absolute top="48%" left="50%" width="384" height="192"}
![](img/tree1.png){.absolute top="48%" left="50%" width=128 height=128}

![](img/table_left.png){.absolute top="80%" left="500" width="114" height="88"}
![](img/table_right.png){.absolute top="80%" left="557" width="92" height="88"}


::: {.notes}
Contributed to 12 HomeTeam games, mostly sound effects (synthetic and recorded, recently got into Audacity filters), also sprites, writing, and shapes.
:::
...
![](video/OneOfTheHerd_Level_3_Trim.mp4)

## Inspiration

"One of the Herd" by Tim Waskett ^[https://stone-baked-games.itch.io/one-of-the-herd]

![](video/OneOfTheHerd_Level_3_Trim.mp4){.absolute top=140 left=0 width="864" height="486"}
