...
Level design is a tile map (edited with a number grid as in the Classic games), sheep placement (currently each sheep is randomly placed in the top quarter of play area to make Calling easy but they could start anywhere), and rogue path loop. Perhaps sheep could be placed in bunches.
